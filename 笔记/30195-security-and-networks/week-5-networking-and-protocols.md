...
*   如果采用租赁线路，而不是专线，就会存在多个用户在使用帧碰撞的问题，于是采用了packet of data来避免碰撞，复用线路。
    ...
    <figure><img src="./assets/image (21) (1).png" alt="" width="375"><figcaption></figcaption></figure>

    <figure><img src="./assets/image (22) (1).png" alt="" width="563"><figcaption></figcaption></figure>
...
*   实际网络模型：
    ...
    <figure><img src="./assets/image (23) (1).png" alt="" width="375"><figcaption></figcaption></figure>
* DHCP用来给新机器动态分配IP，不长期存储
* ARP用来得知MAC和IP的对应关系，前提是使用了NAT服务。
* Wireshark可以进行抓包分析网络
*   模型间传递信息：

    <figure><img src="./assets/image (24) (1).png" alt="" width="375"><figcaption></figcaption></figure>
...
### &#x20;
<figure><img src="./assets/image (25) (1).png" alt="" width="563"><figcaption></figcaption></figure>
<figure><img src="./assets/image (26) (1).png" alt="" width="563"><figcaption></figcaption></figure>


### 简单协议例子

<figure><img src="./assets/image (27).png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (28).png" alt="" width="563"><figcaption></figcaption></figure>

Nonce应该与明文被一同加密，不然可能会被替换重放：
<figure><img src="./assets/image (29).png" alt="" width="563"><figcaption></figcaption></figure>
<img src="./assets/image (30).png" alt="" data-size="original">

<figure><img src="./assets/image (31).png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (32).png" alt="" width="349"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (38).png" alt="" width="375"><figcaption></figcaption></figure>

改进十分简单，在第二步加入身份，这样A就能即时知道他交流的对象不是E而是B了：

<figure><img src="./assets/image (42).png" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (1) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (43).png" alt="" width="375"><figcaption></figcaption></figure>
...
<figure><img src="./assets/image (2) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="563"><figcaption></figcaption></figure>
